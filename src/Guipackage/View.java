...
public class View extends javax.swing.JFrame {
     ...
     private void initialSetup()
    {
       ...
       Employee fs = new Employee();
       
       
       String empTableTitle = "userid \t role\n_______________________________________________________________________\n";
       txtempdetails.setText(empTableTitle + fs.viewAllEmployees());
       
    if (Login.roleType.equals("HRAssistant"))
      {
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(txtempdetails);
        ...
        jTabbedPane1.addTab("Employees_details", jPanel3);
